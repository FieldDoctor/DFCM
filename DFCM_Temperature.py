...
configure['InputFilePath'] = './3-Temperature/2plus-supervisedDataSet_zscore.csv'
configure['OutputFilePath'] = './3-Temperature/6-DFCM.csv'
configure['PltFilePath'] = './3-Temperature/6-DFCM/'
...
configure['OutputAttributes'] = [24,25]
configure['TimeAttributes'] = [0]
configure['Length'] = 2763

configure['global_epochs'] = 400

configure['f_batch_size'] = 1934
configure['f_epochs'] = 15
configure['hidden_layer'] = 20

configure['n_batch_size'] = 1934
...
#optimizers.Adam(lr=0.0005, beta_1=0.9, beta_2=0.999, epsilon=1e-08)
