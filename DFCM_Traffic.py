...
configure['InputFilePath'] = './5-Traffic/2plus-supervisedDataSet_zscore.csv'
configure['OutputFilePath'] = './5-Traffic/6-DFCM.csv'
configure['PltFilePath'] = './5-Traffic/6-DFCM/'
configure['AllAttributes'] = 7
configure['TargetAttributes'] = 6
configure['InputAttributes'] = [1,2,3,4,5,6]
configure['OutputAttributes'] = [8,9,10,11,12,13]
configure['TimeAttributes'] = [0]
configure['Length'] = 3602

configure['global_epochs'] = 400

configure['f_batch_size'] = 900
configure['f_epochs'] = 20
configure['hidden_layer'] = 12

configure['n_batch_size'] = 900
configure['n_epochs'] = 20
