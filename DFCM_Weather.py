...
configure['InputFilePath'] = './4-Weather/2plus-supervisedDataSet_zscore.csv'
configure['OutputFilePath'] = './4-Weather/6-DFCM.csv'
configure['PltFilePath'] = './4-Weather/6-DFCM/'
configure['AllAttributes'] = 10
configure['TargetAttributes'] = 9
configure['InputAttributes'] = [1,2,3,4,5,6,7,8,9]
configure['OutputAttributes'] = [11,12,13,14,15,16,17,18,19]
configure['TimeAttributes'] = [0]
configure['Length'] = 8783

configure['global_epochs'] = 400

configure['f_batch_size'] = 9000
configure['f_epochs'] = 10
configure['hidden_layer'] = 20

configure['n_batch_size'] = 9000
configure['n_epochs'] = 10
